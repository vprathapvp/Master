...
public class BusinessController {
	...
	public ResponseEntity<String> updateAd(@PathVariable("adId") Long adId, @RequestParam("file") MultipartFile file,
			@RequestParam("subscription") String subscription, @RequestParam("distanceRange") String distanceRange,
			@RequestParam("latitude") String latitude, @RequestParam("longitude") String longitude,
			@RequestParam("email") String email, Authentication authentication) {
		...
		try {
			businessService.updateAd(adId, file, subscription, distanceRange, latitude, longitude, email);
