...
public class BusinessServiceImpl implements BusinessService {
	...
	@Override
	public void updateAd(Long adId, MultipartFile file, String subscription, String distanceRange, String latitude,
			String longitude, String email) {
		...
		if (file != null) {
			try {
				existingAd.setAd(file.getBytes());
			} catch (IOException e) {
				throw new RuntimeException("Failed to set ad: " + e.getMessage());
			}
		}
		...
		if (longitude != null && !longitude.isEmpty()) {
			existingAd.setlongitude(longitude);
		}
