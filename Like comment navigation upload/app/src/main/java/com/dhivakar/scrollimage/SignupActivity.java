...
public class SignupActivity extends AppCompatActivity {
    ...
    private void signUp() {
        ...
        if (!isValidPassword(password)) {
            Toast.makeText(SignupActivity.this, "Password must contain at least one letter, one special symbol, and one number", Toast.LENGTH_SHORT).show();
            return;
        }
    ...
    private boolean isValidPassword(String password) {
        // Password must contain at least one letter, one special symbol, and one number
    ...
    private class SignUpTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                URL url = new URL("http://192.168.2.62:8093/register");
